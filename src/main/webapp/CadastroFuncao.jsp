...
<html>
    <head>
        <title>Cadastro de Funções - Aquaminas</title>
    ...
    <body>
        ...
        <table>
            <form id="cadastroForm" name="cadastroForm" action="${pageContext.request.contextPath}${URL_BASE}/FuncaoControlador" method="get">
            ...
            <form  name="cadastroForm" action="${pageContext.request.contextPath}${URL_BASE}/FuncaoControlador" method="get">
                <td>
